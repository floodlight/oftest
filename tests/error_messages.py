...
class HelloFailed(base_tests.SimpleProtocol):
    """
    ...
    def runTest(self):
        ...
        logging.info("Running HelloFailed Test")  
...
class BadRequestBadVersion(base_tests.SimpleProtocol):
    ...
    def runTest(self):
        ...
        logging.info("Running BadRequestBadVersion Test") 
...
class BadRequestBadType(base_tests.SimpleProtocol):
   ...
   and code field OFPBRC_BAD_TYPE
    ...
    def runTest(self):
        ...
        logging.info("Running BadRequestBadType test")
...
class BadRequestBadLength(base_tests.SimpleProtocol):  
    ...
    def runTest(self):
        ...
        logging.info("Running BadRequestBadLength test")
...
class BadRequestBadVendor(base_tests.SimpleProtocol):
    """
...
class BadActionBadType(base_tests.SimpleDataPlane):   
    ...
    def runTest(self):  
        ...
        logging.info("Running BadActionBadType test")
        of_ports = config["port_map"].keys()
        of_ports.sort()
        self.assertTrue(len(of_ports) > 1, "Not enough ports for test")
...
class BadActionBadLen(base_tests.SimpleDataPlane):   
    ...
    def runTest(self):  
        ...
        logging.info("Running BadActionBadLen test")
        of_ports = config["port_map"].keys()
        of_ports.sort()
        self.assertTrue(len(of_ports) > 1, "Not enough ports for test")
...
class BadActionBadOutPort(base_tests.SimpleProtocol):
    ...
    def runTest(self):
        ...
        logging.info("Running BadActionBadPort test")
...
class BadActionQueue(base_tests.SimpleDataPlane):
    """
    ...
    def runTest(self):
        ...
        logging.info("Running BadActionQueue test")
...
class BadActionTooMany(base_tests.SimpleProtocol):
    """
    ...
    def runTest(self):
        ...
        logging.info("Running BadActionTooMany test")
...
class BadActionBadArgument(base_tests.SimpleProtocol):
    """
    Bad action argument.
...
class FlowModFailedOverlap(base_tests.SimpleDataPlane):
    ...
    def runTest(self):
        ...
        logging.info("Running FlowModFailedOverlap test")
...
class FlowModFailedBadEmer(base_tests.SimpleProtocol): 
    ...
    def runTest(self):
        ...
        logging.info("Running FlowModFailedBadEmer test")
...
class FlowModFailedBadCommand(base_tests.SimpleProtocol):   
    """
    Unknown command.
...
class UnsupportedActionlist(base_tests.SimpleProtocol):   
    """
...
class PortModFailedBadPort(base_tests.SimpleProtocol):
    """
    ...
    def runTest(self):
        ...
        logging.info("Running PortModFailedBadPort test")
...
class PortModFailedBadHwAdd(base_tests.SimpleProtocol):    
    ...
    def runTest(self):
        ...
        logging.info("Running PortModFailedBadHwAdd test")
...
class QueueOpFailedBadPort(base_tests.SimpleDataPlane):
    ...
    def runTest(self):
        ...
        logging.info("Running QueueOpFailedBadPort test")
...
class QueueOpFailedBadQueue(base_tests.SimpleDataPlane):
    ...
    def runTest(self):
        ...
        logging.info("Running QueueOpFailedBadQueue test")
